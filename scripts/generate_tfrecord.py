"""
File that takes in the CSV list of images and bounding boxes and creates a TF Record for training/testing the network.
...
Usage:
    ...
    # Create train data:
    python generate_tfrecord.py --csv_input=dot_train_labels.csv  --output_path=train.record
...
def create_tf_example(group, path):
    ...
    for index, row in group.object.iterrows():
        if int(row['xmin']) > -1:
            ...
            classes.append(5000)                             # Does this need to get changed? Or does it not matter
